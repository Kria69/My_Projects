const screensInCalendar = document.querySelectorAll('.calendar > .screen')
...
function handleDayClick(day) {
    screensInCalendar[0].classList.add('up')
    screensInCalendar[1].classList.remove('hidden')
